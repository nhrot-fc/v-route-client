...
export function SimulationConfig({
  ...
  const [simulationType, setSimulationType] = useState<SimulationDTOTypeEnum>(
    SimulationDTOTypeEnum.Weekly,
  );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure los parámetros para iniciar una nueva simulación
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                setSimulationType(value as SimulationDTOTypeEnum)
              }
            >
              ...
              <SelectContent>
                <SelectItem value={SimulationDTOTypeEnum.Weekly}>
                  Semanal
                </SelectItem>
                <SelectItem value={SimulationDTOTypeEnum.Infinite}>
                  Colapso
                </SelectItem>
                <SelectItem value={SimulationDTOTypeEnum.Custom}>
                  Personalizada
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          {simulationType === SimulationDTOTypeEnum.Custom && (
            <div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Indique la cantidad de vehículos de cada tipo que participarán en
              la simulación
            </p>
          </div>
